...
cat > src/audit-native-pages.ts <<'EOF'
...
npm pkg set scripts.audit:native-pages="tsx src/audit-native-pages.ts" >/dev/null

echo
echo "Added src/audit-native-pages.ts"
echo
echo "Run:"
echo "  npx tsc --noEmit"
echo "  npm run audit:native-pages"
