...
cat > src/build-page-corpus.ts <<'EOF'
...
cat > src/audit-page-corpus.ts <<'EOF'
...
npm pkg set scripts.build:pages="tsx src/build-page-corpus.ts" >/dev/null
npm pkg set scripts.audit:pages="tsx src/audit-page-corpus.ts" >/dev/null

echo
echo "Added:"
echo "  src/build-page-corpus.ts"
echo "  src/audit-page-corpus.ts"
echo
echo "Run:"
echo "  npx tsc --noEmit"
echo "  npm run build:pages"
echo "  npm run audit:pages"
